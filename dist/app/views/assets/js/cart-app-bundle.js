...
const axios_wrapper_1 = require("../libs/axios-wrapper");
console.log('hehe');
function addItem(variantId, quantity) {
    axios_wrapper_1.default.post('/cart/add-item', {
        variantId,
        quantity
    }).then(rawResp => {
...
$(window).ready(() => {
    ...
    $('#place-order').on('click', function () {
        ...
        axios_wrapper_1.default.post('/cart/place-order', orderData).then(rawResp => {
            const resp = rawResp.data;
            if (resp.status) {
...
},{"../libs/axios-wrapper":32,"toastr":28}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = {
