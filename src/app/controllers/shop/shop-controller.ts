...
export default class ShopController extends ShopBaseController {
  constructor (siteData: SiteData) {
    ...
    this.routeGet('/', (req, res, next) => {
      ...
      Promise.join<NCResponse<any>>(
        LocalShopService.getPromotedProducts(),
      ...
      ).spread((resp: NCResponse<{products: InStockProduct[], totalProducts: number}>,
        ...
        if (resp.status && resp.data &&
          ...
          res.locals.promotedProducts = resp.data.products
          console.dir('promotedProducst=' + JSON.stringify(resp.data))
